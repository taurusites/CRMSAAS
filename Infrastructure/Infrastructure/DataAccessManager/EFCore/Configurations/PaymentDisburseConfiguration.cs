...
public class PaymentDisburseConfiguration : BaseEntityConfiguration<PaymentDisburse>
{
    public override void Configure(EntityTypeBuilder<PaymentDisburse> builder)
    {
        base.Configure(builder);

        builder.Property(x => x.BillId).HasMaxLength(IdConsts.MaxLength).IsRequired(false);
