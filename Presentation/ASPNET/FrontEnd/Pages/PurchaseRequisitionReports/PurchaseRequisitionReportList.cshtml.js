const App = {
    setup() {
        ...
        const services = {
            getMainData: async () => {
                try {
                    const response = await AxiosManager.get('/PurchaseRequisitionItem/GetPurchaseRequisitionItemList', {});
                    return response;
                } catch (error) {
                    throw error;
                }
        ...
        const mainGrid = {
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    allowGrouping: true,
                    groupSettings: {
                        columns: ['purchaseRequisitionNumber']
                    },
                    allowTextWrap: true,
                    allowResizing: true,
                    allowPaging: true,
                    ...
                    sortSettings: { columns: [{ field: 'purchaseRequisitionNumber', direction: 'Descending' }] },
                    ...
                    columns: [
                        ...
                        { field: 'purchaseRequisitionNumber', headerText: 'Purchase Requisition', width: 200, minWidth: 200 },
                    ...
                    beforeDataBound: () => { },
                    dataBound: function () {
                        mainGrid.obj.autoFitColumns(['vendorName', 'purchaseRequisitionNumber', 'productNumber', 'productName', 'unitPrice', 'quantity', 'total', 'createdAtUtc']);
                    },
                    excelExportComplete: () => { },
                    rowSelected: () => { },
                    rowDeselected: () => { },
